...
function addChapter(){
    ...
    +'<p><textarea name="chapterContent" id="chapterContent" cols="30" rows="10"></textarea></p><input id="addCont" type="button" onClick="addContent()" value="추가">'
...
function addContent(){
	let addFrm = '<p><textarea name="chapterContent" id="chapterContent" cols="30" rows="10"></textarea></p><input id="addCont" type="button" onClick="addContent()" value="추가">';
	$('#inputWrap').append(addFrm);
			...
			<div class="tabs clearfix">
				<div class="tabsLeft">
					<ul>
						...
						<li><a href="http://localhost:8181/debate/debatedetail/${doc[0].docTitle }">토론</a></li>
					</ul>
				</div>
				<div id="simpleSearch">
